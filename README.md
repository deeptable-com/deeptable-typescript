...
[![NPM version](<https://img.shields.io/npm/v/deeptable.svg?label=npm%20(stable)>)](https://npmjs.org/package/deeptable) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/deeptable)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/deeptable-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install deeptable`
...
```ts
import Deeptable from 'npm:deeptable';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/deeptable-typescript/issues) with questions, bugs, or suggestions.
